...
const InputUsername: FC<Props> = ({ setUsername, setUsernameIsValid }) => {
  ...
  const handleChange = () => {
    ...
    username[0].match(/[a-zA-Z]/) ? setRule1(true) : setRule1(false);
    ...
    <>
      <div className='input_username_container'>
        <div className='input_username'>
          <div className='input_username_title'>Nom d'utilisateur :</div>
          <input
          ...
          <>
            <div className='rules_container'>
              ...
              <div className='rules_section'>
                ...
                <div className='rules_text'>
                  Le nom d'utilisateur doit contenir entre 5 et 20 caractères
                </div>
              </div>
            </div>
          </>
